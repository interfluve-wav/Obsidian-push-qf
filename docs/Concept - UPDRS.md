---
title: "Concept — UPDRS (Unified Parkinson's Disease Rating Scale)"
draft: false
tags:
  - concept
  - ai-internship
  - neurology
  - parkinsons-scale
description: "UPDRS: the gold-standard Parkinson's disease rating scale, Parts I-IV, and why it's a gap in ambient scribe products."
---
...
**Why Abridge doesn't own this:** Abridge captures the encounter-level note. It does not aggregate UPDRS scores across visits, compute the trajectory, or surface a trend alert. This is a gap in the chronic disease monitoring layer — exactly the space a pre-visit synthesis tool could fill.
...
> [!info]- Related
> [[Concept - EDSS]] · [[Concept - MIDAS]] · [[Abridge - Gaps|Abridge Gaps]]
