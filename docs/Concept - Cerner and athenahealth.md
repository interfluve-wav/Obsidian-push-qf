...
tags:
  ...
  - neurology
  - EHR
description: "Cerner (now Oracle Health) and athenahealth: market positions, AI strategy, and Abridge integration depth compared to Epic."
---
...
**Abridge's Cerner integration** is described as lighter than Epic — Abridge writes notes back via SMART-on-FHIR, but the depth of workflow automation is not as deep. Cerner's legacy architecture (Millennium platform) has made deep integration harder for third-party vendors.
...
**Abridge's athenahealth integration** uses SMART-on-FHIR for note write-back, similar to Cerner. Ambulatory practices using athenahealth can deploy Abridge without switching EHRs.
...
| EHR | Market segment | Abridge integration depth | Abridge write-back |
|---|---|---|---|
...
> [!info]- Related
> [[Concept - Epic]] · [[Concept - SMART-on-FHIR]] · [[Concept - Dot-Phrase]] · [[Abridge|Abridge Teardown]]
