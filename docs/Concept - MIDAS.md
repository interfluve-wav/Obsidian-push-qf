---
title: "Concept — MIDAS (Migraine Disability Assessment)"
draft: false
tags:
  - concept
  - ai-internship
  - neurology
  - migraine-scale
description: "MIDAS: migraine disability questionnaire, grades I-IV, and why it's a gap in ambient scribe longitudinal tracking."
---
...
**The problem it solves:** Migraine is an episodic condition — the doctor doesn't observe a migraine attack in the office. The MIDAS captures the patient's headache burden over time, enabling the doctor to understand:
- How frequent are the headaches?
- How disabling are they?
- Is the patient deteriorating over months?

**Why Abridge doesn't own this:** Abridge sees only the in-visit conversation. It does not:
...
> [!info]- Related
> [[Concept - UPDRS]] · [[Concept - EDSS]] · [[Abridge - Gaps|Abridge Gaps]]
