#capstone #ai-internship #neurology #concept #evaluation-metric
...
Abrige reports a WER of **12.7%** on their internal medical benchmark — meaning roughly 1 in 8 words is wrong in their transcription. This sounds high, but the comparison is against other medical ASR systems, where Abrige achieves a **24% relative reduction** in WER.
...
Abrige reports both WER and **MTR (Medical Term Recall) of 97%** — meaning 97% of medical terms are correctly recalled/transcribed, even when the broader WER is 12.7%.
...
## WER in the Abrige Benchmarks

From the [[Source - Abrige AI Evaluation Whitepaper]] and [[Source - Abridge Confabulation Elimination Whitepaper]]:

- Abrige internal WER on clinical conversations: **12.7%**
...
The **83% reduction on new medications** is striking — it means Abrige's medical fine-tuning specifically improved accuracy on medication names, which are often the most clinically consequential transcription errors.
...
- [[Concept - MTR]] — Medical Term Recall specifically for clinically critical vocabulary
- Human clinician review of generated notes

See [[Concept - AI Evaluation in Healthcare]] for a full discussion of evaluation frameworks.
...
- [[Concept - ASR]]
- [[Concept - CER]]
- [[Concept - MTR (Medical Term Recall)]]
