#capstone #ai-internship #neurology #concept #clinical-trial-design
...
The **Tierney et al. study** (2025) was published in JAMIA Open. This is the KUMC quality improvement study that provides the 81% / 77% / 73% / 67% / 64% satisfaction figures for Abrige.
...
- "I find my current documentation workflow easy to use" → "Abrige has made my documentation workflow easy to use"
- "I usually complete the note before the next patient visit" → "With Abrige, I could complete the note before the next patient visit"

The 81%, 77%, 73%, etc. figures come from **post-implementation survey responses only** — the percentage of respondents who agreed or strongly agreed with each statement after using Abrige. They are not computed pre/post changes.
